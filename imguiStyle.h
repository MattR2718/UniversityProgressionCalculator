...
void SetDarkThemeColours()
{
    ...
    colors[ImGuiCol_PlotLinesHovered] = ImVec4(1.00f, 0.75f, 0.00f, 1.00f);
    colors[ImGuiCol_PlotHistogram] = ImVec4(0.90f, 0.70f, 0.00f, 1.00f);
    colors[ImGuiCol_PlotHistogramHovered] = ImVec4(1.00f, 0.60f, 0.00f, 1.00f);

    // Text selections
    colors[ImGuiCol_TextSelectedBg] = ImVec4(0.00f, 0.45f, 0.90f, 0.35f);
    ...
    colors[ImGuiCol_TableHeaderBg] = ImVec4(0.30f, 0.30f, 0.30f, 1.00f);
    colors[ImGuiCol_TableBorderStrong] = ImVec4(0.70f, 0.70f, 0.70f, 1.00f);
    colors[ImGuiCol_TableBorderLight] = ImVec4(0.55f, 0.55f, 0.55f, 1.00f);
    colors[ImGuiCol_TableRowBg] = ImVec4(0.20f, 0.20f, 0.20f, 1.00f);
    colors[ImGuiCol_TableRowBgAlt] = ImVec4(0.25f, 0.25f, 0.25f, 1.00f);
